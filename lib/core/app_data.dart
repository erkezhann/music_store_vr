...
class AppData {
  ...
  static List<Instrument> instrumentList = [
    Instrument(
      ...
      price: 201300,
      model: 'assets/images/guitar.webp',
    ...
    Instrument(
      ...
      price: 201300,
      model: 'assets/images/baraban.webp',
      colors: <InstrumentColor>[
    ...
    Instrument(
      ...
      price: 201300,
      model: 'assets/images/scripca.webp',
      colors: <InstrumentColor>[
        InstrumentColor(color: const Color(0xFF616161), isSelected: true),
    ...
    Instrument(
      ...
      price: 201300,
      model: 'assets/images/saksafon.webp',
      colors: <InstrumentColor>[
    ...
    Instrument(
      ...
      price: 201300,
      model: 'assets/images/royal.webp',
      colors: <InstrumentColor>[
        InstrumentColor(color: const Color(0xFF5d4037), isSelected: true),
